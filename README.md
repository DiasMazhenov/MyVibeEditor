...
- Responsive Preview Studio с альбомными профилями планшета/телефона и точной шириной viewport;
...
Кнопка навигации сканирует внутренние ссылки текущей страницы в iframe и показывает их в компактном списке; ссылки открываются в новой вкладке без внешних запросов редактора. В Responsive Preview Studio доступны профили desktop, tablet, tablet landscape, mobile и mobile landscape. Выбор меняет ширину iframe без перезагрузки, запоминается для текущего файла и не меняет исходный HTML.
