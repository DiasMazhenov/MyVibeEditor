...
Скриншоты ниже сняты в браузерной проверке v0.18; v0.20 добавляет регрессионные проверки, расширенное контекстное меню, безопасный вывод статусов и подробную документацию, а v0.21 — CSS-инспектор. Базовая UI-геометрия сохранена.
