...
- Functional version — `0.20`; следующий функциональный номер — `0.21`. Пользовательский `test-page.html` остаётся изменённым локально и не входит в commit.
