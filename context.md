...
- Версия из исходников: MyVibeHTML `0.13`.
...
- Кодовый коммит: будет записан после этого context-предкоммита; следующий functional version — `0.14`.
