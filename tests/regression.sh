...
rg -q "MyVibeHTML v0\.34" myvibehtml.php myvibehtml.js myvibehtml-fallback.css
rg -q "const VERSION = '0\.34'" myvibehtml.php
...
curl -fsS "$BASE_URL/myvibehtml.js?v=0.34" >/dev/null
curl -fsS "$BASE_URL/myvibehtml-source-map.js?v=0.34" >/dev/null
curl -fsS "$BASE_URL/myvibehtml.css?v=0.34" >/dev/null
...
expect_status 403 "$BASE_URL/?q=test-page.html&rev=0.34"
