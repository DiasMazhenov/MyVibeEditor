...
rg -q "MyVibeHTML v0\.62" myvibehtml.php myvibehtml.js myvibehtml-fallback.css myvibehtml-shell-controls.js myvibehtml-transport.js myvibehtml-auth.js
rg -q "const VERSION = '0\.62'" myvibehtml.php
...
curl -fsS "$BASE_URL/myvibehtml.js?v=0.62" >/dev/null
curl -fsS "$BASE_URL/myvibehtml-source-map.js?v=0.62" >/dev/null
curl -fsS "$BASE_URL/myvibehtml-ui-contracts.js?v=0.62" >/dev/null
curl -fsS "$BASE_URL/myvibehtml-transport.js?v=0.62" >/dev/null
curl -fsS "$BASE_URL/myvibehtml-auth.js?v=0.62" >/dev/null
curl -fsS "$BASE_URL/myvibehtml-shell-controls.js?v=0.62" >/dev/null
curl -fsS "$BASE_URL/myvibehtml.css?v=0.62" >/dev/null
curl -fsS "$BASE_URL/myvibehtml-theme.css?v=0.62" >/dev/null
curl -fsS "$BASE_URL/myvibehtml-fallback.css?v=0.62" >/dev/null
...
expect_status 403 "$BASE_URL/?q=test-page.html&rev=0.62"
