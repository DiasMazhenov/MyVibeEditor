...
rg -q "MyVibeHTML v0\.20" myvibehtml.php myvibehtml.js myvibehtml.css myvibehtml-fallback.css
rg -q "const VERSION = '0\.20'" myvibehtml.php
...
curl -fsS "$BASE_URL/myvibehtml.js?v=0.20" >/dev/null
curl -fsS "$BASE_URL/myvibehtml.css?v=0.20" >/dev/null
...
expect_status 403 "$BASE_URL/?q=test-page.html&rev=0.20"
