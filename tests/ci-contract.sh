...
rg -q "MyVibeHTML v0\.74|const VERSION = '0\.74'" myvibehtml.php myvibehtml.js myvibehtml-runtime.php myvibehtml-source-map.js myvibehtml-ui-contracts.js myvibehtml-shell-controls.js myvibehtml-transport.js myvibehtml-auth.js
