...
rg -q "MyVibeHTML v0\.70|const VERSION = '0\.70'" myvibehtml.php myvibehtml.js myvibehtml-runtime.php myvibehtml-source-map.js myvibehtml-ui-contracts.js myvibehtml-shell-controls.js myvibehtml-transport.js myvibehtml-auth.js
