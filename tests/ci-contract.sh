...
test -s myvibehtml-admin.css
test -s myvibehtml-admin.js
...
rg -q "MyVibeHTML v0\.84|const VERSION = '0\.84'" myvibehtml.php myvibehtml.js myvibehtml-runtime.php myvibehtml-source-map.js myvibehtml-ui-contracts.js myvibehtml-shell-controls.js myvibehtml-transport.js myvibehtml-auth.js
