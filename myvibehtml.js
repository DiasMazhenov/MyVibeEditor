...
(function() {
    var _1 = window,
        ...
        $N = '<br>',
        $O = $M + $N + $L;
    var writeCookie = function(a, b, c, d) {
        ...
        animateValue = function(b, c, d, e, f, g, h) {
            var i, j = new Date(),
                k = _1[_a](function() {
                    i = (new Date() - j) / e;
        ...
        fadeIn = function(c, d) {
            if (_1[_f](c)[r_] == E_) {
                c[g_][s_] = '0';
                c[g_][r_] = F_;
                animateValue(c, 0, 1, 400, function(a) {
        ...
        fadeOut = function(c, d) {
            if (c[g_][t_] != G_ && _1[_f](c)[r_] != E_) {
                animateValue(c, 1, 0, 300, function(a) {
                    return ((-Math.cos(a * Math.PI) / 2) + 0.5)
                }, function(b) {
                    c[g_][s_] = b[_I](1)
                }, function() {
        ...
        slideDown = function(i, j) {
            if (_1[_f](i)[r_] == E_) {
                ...
                if (l) {
                    k = k - l;
                    animateValue(i, 0, l, 200, function(a) {
                        return ((-Math.cos(a * Math.PI) / 2) + 0.5)
                    }, function(b) {
                        i[g_][z_] = b[_I](0) + 'px'
                    })
                }
                animateValue(i, 0, k, 200, function(c) {
                    return ((-Math.cos(c * Math.PI) / 2) + 0.5)
                }, function(d) {
                    i[g_][v_] = d[_I](0) + 'px'
                });
                animateValue(i, parseInt(i[g_][C_]), 0, 400, function(e) {
                    return ((-Math.cos(e * Math.PI) / 2) + 0.5)
                }, function(f) {
                    i[g_][C_] = f[_I](0) + 'px'
                });
                animateValue(i, 0, 1, 600, function(g) {
        ...
        slideUp = function(i, j) {
            if (i[g_][t_] != G_ && _1[_f](i)[r_] != E_) {
                ...
                if (l) {
                    k = k - l;
                    animateValue(i, l, 0, 400, function(a) {
                        return ((-Math.cos(a * Math.PI) / 2) + 0.5)
                    }, function(b) {
                        i[g_][z_] = b[_I](0) + 'px'
                    })
                }
                animateValue(i, i[c_], 0, 420, function(c) {
                    return ((-Math.cos(c * Math.PI) / 2) + 0.5)
                }, function(d) {
                    i[g_][v_] = d[_I](0) + 'px'
                }, function() {
                ...
                animateValue(i, 0, parseInt('-' + _1[_f](i[_u])[A_]), 400, function(e) {
                    return ((-Math.cos(e * Math.PI) / 2) + 0.5)
                }, function(f) {
                    i[g_][C_] = f[_I](0) + 'px'
                });
                animateValue(i, 1, 0, 200, function(g) {
                    return ((-Math.cos(g * Math.PI) / 2) + 0.5)
                }, function(h) {
                    i[g_][s_] = h[_I](1)
                })
        ...
        showPanel = function(e, f) {
            if (_1[_f](e)[r_] == E_) {
                ...
                e[g_][u_] = '';
                e[g_][t_] = G_;
                animateValue(e, 0, g, 150, function(a) {
                    return ((-Math.cos(a * Math.PI) / 2) + 0.5)
                }, function(b) {
                    e[g_][v_] = b[_I](0) + 'px'
                });
                animateValue(e, 0, 1, 300, function(c) {
                    return ((-Math.cos(c * Math.PI) / 2) + 0.5)
                }, function(d) {
                    e[g_][s_] = d[_I](1)
                }, function() {
        ...
        hidePanel = function(e, f) {
            if (e[g_][t_] != G_ && _1[_f](e)[r_] != E_) {
                var g = e[c_];
                e[g_][t_] = G_;
                animateValue(e, e[c_], 0, 200, function(a) {
                    return ((-Math.cos(a * Math.PI) / 2) + 0.5)
                }, function(b) {
                    e[g_][v_] = b[_I](0) + 'px'
                }, function() {
                ...
                animateValue(e, 1, 0, 150, function(c) {
                    return ((-Math.cos(c * Math.PI) / 2) + 0.5)
                }, function(d) {
                    e[g_][s_] = d[_I](1)
                })
    ...
    _2[_g](I_, function() {
        ...
        if (authPage) {
            var loginButton = authPage[_m]('input[type="button"]'),
                passwordInput = authPage[_m]('input[type="password"]'),
                passwordToggle = passwordInput[_w],
                authStatus = authPage[_m]('p samp'),
                attemptList = authPage[_m]('ol'),
                attemptTemplate = attemptList[_n](attemptList[_u]),
                maxAttempts = attemptList[_i]($ + 'cp'),
                failedAttempts = attemptList[_i]($ + 'cq'),
                ...
                handleLoginKeydown = function(event) {
                    if (event[q_] == 13) {
                        passwordInput[_h](S_, updateLoginButton);
                        startLogin()
                    }
                },
                updateLoginButton = function() {
                    if (passwordInput[h_][f_] > 0) loginButton[d_] = false;
                    else loginButton[d_] = true
                },
                startLogin = function() {
                    if (!loginButton[d_]) {
                        passwordInput[K_]();
                        passwordInput[d_] = true;
                        loginButton[d_] = true;
                        authStatus[i_] = authStatus[_i]($ + 'az');
                        authStatus[b_] = 'b';
                        fadeIn(authStatus);
                        hashPassword(passwordInput[h_], passwordInput[_i]($ + 'bb'), 200, submitLogin)
                    }
                },
                hashPassword = function(b, c, d, e) {
                    var f = 0,
                        g = sha1(sha1(b)[_K](0, 22) + b),
                        h = _1[_a](function() {
                            for (var a = f + d; f < a; f++) {
                                if (f < c) g = sha1(g);
                                else {
                ...
                submitLogin = function(k) {
                    authStatus[i_] = authStatus[_i]($ + 'cr');
                    ajaxRequest('password=' + k, function() {
                        writeCookie($b, 1, false, authStatus[_i]($ + 'cl'));
                        authStatus[i_] = authStatus[_i]($ + 'cs');
                        authStatus[b_] = 'c';
                        if (_3.href[_E](_1[_e](authStatus[_i]($ + 'cl'))[_P]('%2F')[_Q]('/')) === -1) {
                            var i = authStatus[_i]($ + 'cl')[_P]('/'),
                                j = _3.hostname[_L]('www.', '');
                            if (i[f_] > 3 && j[_E](i[1]) === 0 && j[_P]('.')[f_] > 2) _3.href = _3.protocol + '//' + j[_O](i[1][f_] + 1) + authStatus[_i]($ + 'cl');
                            else _3.reload(true)
                        } else _3.reload(true)
                    }, function() {
                        passwordInput[d_] = false;
                        passwordInput[K_]();
                        passwordInput[_g](S_, updateLoginButton);
                        authStatus[b_] = 'd';
                        if (!this[l_]('X-a')) {
                            authStatus[i_] = authStatus[_i]($ + 'ct');
                            failedAttempts = failedAttempts * 1 + 1;
                            attemptList[_j]($ + 'cq', failedAttempts);
                            if (failedAttempts >= maxAttempts) _3.reload(true);
                            else attemptList[_o](attemptList[_u])[b_] = 'a'
                        } else {
                            updateLoginButton.call(passwordInput);
                            authStatus[i_] = authStatus[_i]($ + 'am')
                        }
                    }, function() {
                        passwordInput[d_] = false;
                        passwordInput[K_]();
                        passwordInput[_g](S_, updateLoginButton);
                        authStatus[i_] = authStatus[_i]($ + 'al');
                        authStatus[b_] = 'd'
                    })
                };
            for (var attemptIndex = 0; attemptIndex < maxAttempts; attemptIndex++) {
                var attemptRow = attemptTemplate[_p](true);
                if (attemptIndex >= (maxAttempts - failedAttempts)) attemptRow[b_] = 'a';
                attemptList[_o](attemptRow)
            }
            if (_3.href[_E](_1[_e](authStatus[_i]($ + 'cl'))[_P]('%2F')[_Q]('/')) === -1) {
                authStatus[b_] = 'd';
                fadeIn(authStatus)
            } else if (loginButton[h_][_E]('{') !== -1) {
                authStatus[i_] = 'Problem with parse_ini_file';
                authStatus[b_] = 'd';
                fadeIn(authStatus)
            }
            attemptList[g_][r_] = F_;
            passwordInput[K_]();
            passwordToggle.title = passwordToggle[_i]($ + 'bx');
            passwordToggle[_g](N_, togglePasswordVisibility);
            loginButton[_g](J_, startLogin);
            passwordInput[_g](S_, updateLoginButton);
            passwordInput[_g](P_, handleLoginKeydown)
        }
    });
    _2[_g](I_, function() {
        var da = _2[_m]('#e');
        if (da) {
            var db = da[_m]('div>div+ol li:first-child'),
                ...
                dd = da[_m]('div>div+ul li:first-child input'),
                de = da[_m]('div>div+ul li:last-child input'),
                df = da[_m]('div>div+ul+p samp'),
                dg = da[_l]('div>ol+ul>li>a'),
                dh = _2[_m]('#j'),
                serializedSource = dh[i_],
                initializeVisualEditor = function() {
                    var ga = da[_m]('div>ul+div'),
                        gb = ga[_u],
                        gc = gb[_i]($ + 'ab'),
                        gd = gb[_w],
                        ge = gd[_u],
                        ...
                        gq = function(a) {
                            ...
                            for (var c = 0, d = b[f_]; c < d; c++) {
                                ...
                                if (e && b[c][_i]($l) && e[_i]($l)) {
                                    var f = b[c][i_][_L](new RegExp('^([\\S\\s]+?)\\s*$', 'gi'), '$1'),
                                        g = e[i_];
                                    b[c][i_] = f + g;
                                    var h = b[c].B,
                                        i = e.B;
                                    if (h || i) {
                                        if (!h) h = f;
                                        else h = h[_L](new RegExp('^([\\S\\s]+?)\\s*$', 'gi'), '$1');
                                        if (!i) i = g;
                                        b[c].B = h + i
                                    }
                                    e[_z][_n](e)
                        ...
                        gr = function() {
                            var a = false;
                            if (serializedSource != dh[i_]) a = true;
                            else {
                                var b = hs[_l]('[' + $l + ']'),
                                    c = hs[_l]('[' + $y + ']');
                        ...
                        gv = function() {
                            ...
                            for (var c = 0, d = a[f_]; c < d; c++) {
                                ...
                                if (e && e != f) {
                                    var g = gT('>' + e + '<'),
                                        h = g[f_] - 1;
                                    if (h && sha1(_3.hostname[_L]('www.', ''))) {
                                        if (h == 1) {
                                            serializedSource = g[_Q]('>' + f + '<');
                                        ...
                                        if (typeof s[t][$z + gm[v]] != 'undefined') {
                                            ...
                                            if (y != z) {
                                                var A = hj(x, gm[v], z),
                                                    ...
                                                    C = B[_E](s[t]);
                                                if (A[f_] == B[f_] && C !== -1) {
                                                    for (var c = 0, D = serializedSource, d = A[f_]; c < d; c++) D = D[_P](A[c])[_Q]('{-' + z + '-}');
                        ...
                        gF = function() {
                            ...
                            if (d) {
                                var e = gJ(d),
                                    f = gK(d);
                                if (e && f) {
                                    serializedSource = serializedSource[_O](0, f) + serializedSource[_O](e, f) + serializedSource[_O](f);
                                    var g = d[_p](true),
                                        h = g[_l]('[' + $l + ']'),
                                        i = g[_l]($C),
                                        j = g[_l](gn);
                                ...
                                for (var b = [], c = a[_x]; c; c = c[_x]) {
                                    ...
                                    if (d != $F && d != 'style' && e) {
                                        var g = gJ(a),
                                            h = gK(a);
                                        if (g && h) {
                                            serializedSource = serializedSource[_O](0, e) + serializedSource[_O](g, h) + serializedSource[_O](e, g) + serializedSource[_O](h);
                                            var i = a[_w];
                                            for (var j = 0, k = b[f_]; j < k; j++) {
                                                if (i) i[_z][_r](b[b[f_] - 1 - j], i);
                                                else a[_z][_o](b[b[f_] - 1 - j])
                                            }
                                            gq(a[_z]);
                                            gy(a)
                                        }
                                ...
                                for (var b = [], c = a[_w]; c; c = c[_w]) {
                                    ...
                                    if (d != $F && d != 'style' && e) {
                                        var f = gJ(a),
                                            g = gK(a);
                                        if (f && g) {
                                            serializedSource = serializedSource[_O](0, f) + serializedSource[_O](g, e) + serializedSource[_O](f, g) + serializedSource[_O](e);
                        ...
                        gI = function() {
                            ...
                            if (a) {
                                ...
                                if (b && c) {
                                    var d = a[_z];
                                    serializedSource = serializedSource[_O](0, b) + serializedSource[_O](c);
                                    gz();
                                    d[_n](a);
                                    gq(d)
                                }
                        ...
                        gJ = function(a) {
                            ...
                            } else if (a[_Z][_G]() == 'edit' && a[_i]($l)) return gM(a);
                            else {
                                if (a[_m]($C)) return gO(a);
                                else if (a[_m](gn)) return gQ(a)
                            }
                        },
                        gK = function(a) {
                            var b = a[_w];
                        ...
                        gL = function(a) {
                            ...
                            } else if (a[_Z][_G]() == 'edit' && a[_i]('[' + $l + ']')) return gN(a);
                            else {
                                if (a[_m]($C)) return gP(a);
                                else if (a[_m](gn)) return gR(a)
                            }
                        },
                        gM = function(a) {
                            var b = gS(a)[_L](new RegExp('^\\s*([\\S\\s]+?)$', 'gi'), '$1'),
                                c = gT(b + '<'),
                                d = c[f_] - 1;
                            if (d) {
                                if (d == 1) return serializedSource[_E](b + '<');
                                else {
                                    var e = hs[_l]('[' + $l + ']');
                                    ...
                                    for (var f = 1, k = [c[0]], i = c[f_]; f < i; f++) {
                                        if (c[f][_N](new RegExp('>\\s*$', 'gi'))) k[k[f_]] = c[f];
                                        else k[k[f_] - 1] += (b + c[f] + '<')
                                    }
                                    if (k[f_] == (g + 1) && h !== false)
                                        for (var f = 0, i = k[f_]; f < i; f++)
                                            if ((h + 1) == f) return k[_O](0, f)[_Q](b + '<')[f_]
                                }
                            }
                        },
                        gN = function(a) {
                            var b = gS(a)[_L](new RegExp('^\\s*([\\S\\s]+?)$', 'gi'), '$1'),
                                ...
                                d = c[f_] - 1;
                            if (d) {
                                if (d == 1) return serializedSource[_E](b + '<') + b[f_];
                                else {
                                    var e = hs[_l]('[' + $l + ']');
                                    ...
                                    if (k[f_] == (g + 1) && h !== false)
                                        for (var f = 0, i = k[f_]; f < i; f++)
                                            if ((h + 1) == f) return k[_O](0, f)[_Q](b + '<')[f_] + b[f_]
                                }
                            }
                        },
                        gO = function(a) {
                            ...
                            if (b) {
                                var c = b[_i]($D),
                                    ...
                                    f = e[_E](b);
                                if (d[f_] == e[f_] && f !== -1) {
                                    for (var g = 0, h = serializedSource, i = d[f_]; g < i; g++) h = h[_P](d[g])[_Q]('{-' + c + '-}{' + g + '}');
                        ...
                        gQ = function(a) {
                            ...
                            if (b) {
                                var c = b[_Z][_G](),
                                    d = serializedSource[_N](new RegExp('<' + c + '[^>]*?>', 'gi')),
                                    e = Array.prototype[_O].call(hs.body[_l](c)),
                                    f = e[_E](b);
                                if (d[f_] == e[f_] && f !== -1) {
                                    for (var g = 0, h = serializedSource, i = d[f_]; g < i; g++) h = h[_P](d[g])[_Q]('{-' + c + '-}{' + g + '}');
                                    h = h[_P]('{-' + c + '-}')[_O](0, f + 1)[_Q]('{-' + c + '-}');
                        ...
                        gT = function(a) {
                            var b = serializedSource[_P](a);
                            if (!gw.fixed) {
                                var c = gw(serializedSource),
                                    d = c[_P](a);
                                if (b[f_] != d[f_]) {
                                    serializedSource = c;
                                    if (dh[i_] != serializedSource) dh[i_] = serializedSource;
                                    b = d;
                                    gw.fixed = true
                                }
                            }
                        ...
                        gZ = function(event) {
                            if (event[q_] == 13) {
                                ...
                                resetEditorFocus();
                                gz()
                            } else if (event[q_] == 17) gZ.i = true;
                            else if (event[q_] == 83 && gZ.i) {
                                event[n_]();
                                if (!dd[d_]) {
                                    resetEditorFocus();
                                    gz();
                                    saveEditorContent(gv())
                                }
                            }
                        },
                        hb = function(event) {
                                    ...
                                    if (jd.size < je && jd.size < jf) {
                                        ...
                                        ajaxRequest(jg, function(a) {
                                            ...
                                            if (d[f_] == e[f_] && f !== -1) {
                                                    ...
                                                    if (g) {
                                                        ...
                                                        if (jb(h, b)) {
                                                            ...
                                                            if (i[f_] == j[f_] && k !== -1) {
                                                                ...
                                                                for (var m = 0, n = serializedSource, o = i[f_]; m < o; m++) n = n[_P](i[m])[_Q]('{-' + h + '-}');
                                                ...
                                                for (var m = 0, n = serializedSource, o = d[f_]; m < o; m++) n = n[_P](d[m])[_Q]('{-' + b + '-}');
                                            ...
                                            jc[_k]($p);
                                            df[b_] = 'd';
                                            if (this[l_]('X-d')) df[i_] = df[_i]($ + 'bf');
                                            else if (this[l_]('X-b')) df[i_] = df[_i]($ + 'bo');
                                            else df[i_] = df[_i]($ + 'be')
                                        }, function() {
                                            jc[_k]($p);
                                            df[i_] = df[_i]($ + 'al');
                                        ...
                                        jc[_k]($o);
                                        if (je > jf) df[i_] = df[_i]($ + 'bh') + ' (' + formatBytes(jf) + ')';
                                        else df[i_] = df[_i]($ + 'bh') + ' (' + formatBytes(je) + ')';
                                        df[b_] = 'o';
                                        fadeIn(df)
                                    }
                                } else {
                                    ...
                                    if (jj && jj[_Z][_G]() == $C && jc[_Z][_G]() == $C) {
                                        if (jj != jc) {
                                            ...
                                            if (js[f_] == ju[f_] && jt[f_] == jv[f_] && jw !== -1 && jx !== -1) {
                                                if (jk != jo) {
                                                    ...
                                                    for (var jG = 0, jA = serializedSource, jH = js[f_]; jG < jH; jG++) jA = jA[_P](js[jG])[_Q]('{+' + jk + '+}');
                                        ...
                                        if (jR && (jR = jR[_N](new RegExp('http[a-z0-9-=?&.:/]+?(?:png|jpe?g|gif)', 'gi')) + '') && jR !== 'null') {
                                            ...
                                            if (jS[f_] == jT[f_] && jx !== -1) {
                                                    ...
                                                    if (jU) {
                                                        ...
                                                        if (jb(jV, jQ)) {
                                                            var jW = hj('a', 'href', jV),
                                                                ...
                                                                jY = jX[_E](jU);
                                                            if (jW[f_] == jX[f_] && jY !== -1) {
                                                                for (var jG = 0, jA = serializedSource, jH = jW[f_]; jG < jH; jG++) jA = jA[_P](jW[jG])[_Q]('{-' + jV + '-}');
                                                ...
                                                for (var jG = 0, jA = serializedSource, jH = jS[f_]; jG < jH; jG++) jA = jA[_P](jS[jG])[_Q]('{-' + jQ + '-}');
                                        ...
                                        if (ke && ke[_Z][_G]() == $G) {
                                            ...
                                            if (jR && (jR = jR[_N](new RegExp('http[a-z0-9-=_?&.:/]{2,100}', 'gi')) + '') && jR !== 'null') {
                                                ...
                                                if (kf == kg && kh[f_] == ki[f_]) {
                                                    var kj = jQ[_P](ki)[_Q](kh),
                                                        kk = hj($G, $D, jQ),
                                                        kl = hk($G, $D, jQ),
                                                        jx = kl[_E](ke);
                                                    if (kk[f_] == kl[f_] && jx !== -1) {
                                                        for (var jG = 0, jA = serializedSource, jH = kk[f_]; jG < jH; jG++) jA = jA[_P](kk[jG])[_Q]('{-' + jQ + '-}');
                        ...
                        hj = function(a, b, c) {
                            var d = serializedSource[_N](new RegExp('<' + a + '\\s+?(?:[^>]+?\\s+?)?' + b + '[^>]+?>', 'gi'));
                            for (var e = 0, f = [], g = d[f_]; e < g; e++) {
                                var h = d[e][_N](new RegExp('^<' + a + '\\s+?(?:[^>]+?\\s+?)?' + b + '\\s*=\\s*"', 'gi'));
                                if (!h) {
                                    h = d[e][_N](new RegExp('^<' + a + '\\s+?(?:[^>]+?\\s+?)?' + b + '\\s*=\\s*\'', 'gi'));
                                    if (!h) h = d[e][_L](new RegExp('^<' + a + '\\s+?(?:[^>]+?\\s+?)?' + b + '\\s*=', 'gi'), '')[_N](new RegExp('^[^\\s>]+', 'gi'));
                        ...
                        hm = function(a, b) {
                            var c = [],
                                d = a[_G]()[_N](new RegExp('/[a-z0-9]+>', 'gi')),
                                e = a[_G]()[_N](new RegExp('/[a-z0-9]+>\\s*', 'gi')),
                                f = b[_G]()[_N](new RegExp('/[a-z0-9]+>', 'gi'));
                            for (var g = 0, h = serializedSource[f_] - a[f_] - 1, i = d[f_]; g < i; g++) {
                                c[g] = serializedSource[_O](h)[_E](d[g]) + h + e[g][f_];
                                h = c[g]
                            }
                            ...
                            if (g === 0) return c[g] - e[g][f_] - 1;
                            else return c[g - 1]
                        },
                        hn = function(a) {
                            var b = hs.body[_l]('[' + $l + ']');
                            for (var c = 0, d = [], e = b[f_]; c < e; c++)
                                if (a == gS(b[c])) d[d[f_]] = b[c];
                            return d
                        },
                        ho = function(a) {
                            hp.o = [], hp.p = [];
                            ...
                            if ((df[_i]($ + 'cg') * 1)) {
                                ...
                                if (b) {
                                    b[_g](J_, function() {
                                        ...
                                        _1[_c](df.a);
                                        df[g_][s_] = '';
                                        ajaxRequest('scripts=1' + $s + a, function() {
                                            writeCookie($k, 1);
                    ...
                    db[_g](J_, function() {
                        ...
                        if (b) {
                            var c = gJ(b),
                                d = gK(b);
                            if (c && d) {
                                serializedSource = serializedSource[_O](0, c) + '<fo' + 'cus>' + serializedSource[_O](c, d) + '</fo' + 'cus>' + serializedSource[_O](d);
                                a = gv()
                            }
                        }
                        if (!dd[d_] && !a) a = gv();
                ...
                initializeSourceEditor = function() {
                    ...
                    if (M[b_] == 'html') {
                        ...
                        T = function(i) {
                            return R(Q(i)[_L](new RegExp('([^a-z0-9_$<]|^)([a-z]{2,10})(?=[^a-z0-9_$>])', 'gi'), function(str1, j, k) {
                                if ((P + 'var|this|delete|nan|undefined|typeof|in|with|label|void|')[_E]('|' + k + '|') !== -1) return j + $L + 'f>' + k + $M;
                                else return str1
                        ...
                        T = function(n) {
                            return R(Q(n)[_L](new RegExp('(&lt;[?](?:php)?)(.*?)([?]&gt;)', 'gi'), function(str1, o, p, q) {
                                p = p[_L](new RegExp('([^a-z0-9_$<]|^)([a-z]{2,10})(?=[^a-z0-9_$>])', 'gi'), function(str1, o, p) {
                                    if ((P + 'foreach|as|require|include|require_once|include_once|elseif|endif|endswitch|class|public|private|protected|final|static|abstract|extends|interface|implements|use|const|global|or|and|xor|clone|namespace|trait|yield|declare|goto|')[_E]('|' + p + '|') !== -1) return o + $L + 'f>' + p + $M;
                                    else return str1
                    ...
                    var U = function() {
                        ...
                        Z = function(event) {
                            if (event[q_] == 9) Y();
                            else if (event[q_] == 17) hb.i = false;
                            if (Z.k) _1[_d](Z.k);
                            Z.k = _1[_b](function() {
                                Z.k = false;
                                V()
                        ...
                        hb = function(event) {
                            ...
                            else if (event[q_] == 17) hb.i = true;
                            else if (event[q_] == 90 && hb.i) {
                                event[n_]();
                                if (M.g[f_] > 1) {
                                    M.g.pop();
                ...
                saveEditorContent = function(d) {
                    var e = generateToken();
                    if (saveEditorContent.f) writeCookie($g, e);
                    else d = '';
                    df[i_] = df[_i]($ + 'ad');
                    df[b_] = 'b';
                    fadeIn(df);
                    dd[d_] = true;
                    resetEditorFocus();
                    ajaxRequest('save=' + _1[_e](base64Encode(d)[_P]('a')[_Q]('_')) + $s + e, function() {
                        ...
                        df[i_] = df[_i]($ + 'ae');
                        df[b_] = 'c';
                        if (de[h_] == de[_i]($ + 'ac')) logout()
                    }, function() {
                        dd[d_] = false;
                        dd[K_]();
                        df[b_] = 'd';
                        if (this[l_]('X-a')) df[i_] = df[_i]($ + 'am');
                        else if (this[l_]('X-b')) df[i_] = df[_i]($ + 'bo');
                        else df[i_] = df[_i]($ + 'aj')
                    }, function() {
                        dd[d_] = false;
            ...
            _2[_g](N_, handleEditorSelection);
            de[_g](J_, function() {
                if (dd[d_] || de[h_] == de[_i]($ + 'ac')) logout();
                else {
                    de[h_] = de[_i]($ + 'ac');
                    df[i_] = df[_i]($ + 'af');
                    df[b_] = 'o';
            ...
            _1[_a](function() {
                ajaxRequest('reload=1', function() {
                    if (df[g_][r_] == F_ && (df[i_] == df[_i]($ + 'ah') || df[i_] == df[_i]($ + 'al'))) fadeOut(df)
                }, function() {
            ...
            de[d_] = false;
            if (dh[_i]($ + 'cu')) dd[d_] = false;
            if (df[_i]($ + 'ck') == df[_i]($ + 'cj') || (df[_i]($ + 'ck')[_K](0, 3) == '127' && df[_i]($ + 'cj')[_K](0, 3) == '127')) ajaxRequest.m = true;
            if (_2[_C].id == 'c') initializeSourceEditor();
            else if (_2[_C].id == 'd') initializeVisualEditor();
            checkForUpdates()
        }
    });
    _2[_g](I_, function() {
        var da = _2[_m]('#e'),
            db = _2[_m]('#f');
        if (da && db) {
            var dc = da[_m]('div>div+ul+p samp'),
            ...
            var revealCurrentPath = function(b) {
                    var c = b[_w],
                        d = b[_u][_u],
                        e = d[_i]($ + 'cy'),
                        f = function() {
                            ...
                            if (a != -1) {
                                ...
                                if (d) revealCurrentPath(d[_z][_z])
                            } else {
                ...
                openDirectory = function() {
                    ...
                    ajaxRequest('open=' + _1[_e](k), function(a) {
                        ...
                        if (f) {
                            var g = j[_u][_w];
                            g[i_] = formatBytes(f * 1);
                            if (f[f_] > 9) g[b_] = 'y'
                        }
                    }, function() {
                        i[b_] = '';
                        h[_g](J_, openDirectory);
                        dc[i_] = dc[_i]($ + 'aj');
                        dc[b_] = 'd';
                        fadeIn(dc)
                    }, function() {
                ...
                expandDirectory = function() {
                    var a = this,
                        ...
                        c = b[_z][_w],
                        d = function() {
                            a[_g](J_, collapseDirectory);
                            b[b_] = 't';
                            a.l()
                        };
                    if (c[_u]) slideDown(c, d);
                    else d();
                    a[_h](J_, expandDirectory)
                },
                collapseDirectory = function() {
                    var a = this,
                        ...
                        c = b[_z][_w],
                        d = function() {
                            a[_g](J_, expandDirectory);
                            b[b_] = ''
                        };
                    if (c[_u]) slideUp(c, d);
                    else d();
                    a[_h](J_, collapseDirectory)
                },
                initializeFileEntry = function(a) {
                    var b = a[_u],
                        c = b[_w],
                        d = c[_w],
                        e = a[_v][_u],
                    ...
                    if (a[b_] == 's' || a[b_] == 'u') {
                        f.l = function() {
                            f.l = function() {};
                            expandDirectory.call(f)
                        };
                        f[_g](J_, openDirectory);
                        if (h && g[_O](0, h[f_]) == h) {
                            if (a[b_] == 'u' && a[_w][_u]) e[_g](J_, recoverBackup);
                            else e[b_] = 'n'
                        } else e[_g](J_, queueUploads)
                    } else {
                ...
                renderFileSize = function(a) {
                    var b = a[_i]($ + 'cz');
                    if (b) a[i_] = formatBytes(b * 1);
                    if (b[f_] > 9) a[b_] = 'y'
                },
                renderFileDate = function(a) {
                    var b = a[i_] * 1000,
                        c = new Date(b),
                        d = new Date().getTime(),
                        e = 24 * 60 * 60 * 1000,
                        f = e * 7;
                    if ((d - b) < e) a[b_] = 'w';
                    else if ((d - b) < f) a[b_] = 'x';
                    a[i_] = padDatePart(c.getDate()) + '.' + padDatePart(c.getMonth() + 1) + '.' + ((c.getFullYear() + '')[_O](2)) + ' ' + padDatePart(c.getHours()) + ':' + padDatePart(c.getMinutes())
                },
                padDatePart = function(a) {
                    return (a < 10) ? '0' + a : a
                },
                        ...
                        h[_g](R_, function() {
                            ...
                            if (e <= c) {
                                ...
                                if (g.size < a && g.size < b) {
                                    ...
                                    if (a > b) dc[i_] = dc[_i]($ + 'bh') + ' (' + formatBytes(b) + ')';
                                    else dc[i_] = dc[_i]($ + 'bh') + ' (' + formatBytes(a) + ')';
                                    dc[b_] = 'o';
                                    fadeIn(dc)
                                }
                            } else {
                ...
                uploadFile = function(p) {
                    ...
                    ajaxRequest(q, function(a) {
                            ...
                            if (c[_u]) {
                                ...
                                while (g = f[_u]) {
                                    ...
                                    if (h && i[f_]) {
                                        var j = h[_i]($ + 'cy');
                                        for (var k = 0, l = i[f_]; k < l; k++)
                                            if (i[k][_i]($ + 'cy') == j) i[k][_z][_z][g_][r_] = E_
                                    }
                                    c[_o](g);
                                    initializeFileEntry(g[_u])
                                }
                                fadeIn(c)
                            } else {
                                var h = d[_u];
                                h.l = function() {
                                    ...
                                    expandDirectory.call(h)
                                };
                                openDirectory.call(h);
                                d[b_] = ''
                            }
                            var m = this[l_]('X-c');
                            if (m) {
                                e[i_] = formatBytes(m * 1);
                                if (m[f_] > 9) e[b_] = 'y'
                            }
                            uploadFile.v += p.size;
                            if (this[l_]('X-d')) processUploadQueue(3);
                            else if (this[l_]('X-b')) processUploadQueue(4);
                            else if (this[l_]('X-e')) processUploadQueue(2);
                        ...
                        if (dc[i_][_E]('(') != -1) dc[i_] = t + ' (' + ((n + uploadFile.v) * 100 / uploadFile.w)[_I](1) + '%)'
                    })
                },
                processUploadQueue = function(a) {
                    if (typeof uploadFile.u == 'undefined' || uploadFile.u < a) uploadFile.u = a;
                    if (uploadFile.s && uploadFile.s[f_]) uploadFile(uploadFile.s.shift());
                    else {
                        switch (uploadFile.u) {
                            case 0: {
                                dc[i_] = dc[_i]($ + 'bd');
                ...
                deleteFile = function() {
                    var i = this[_w],
                        ...
                        l = function() {
                            ...
                            fadeIn(dc);
                            e[g_][r_] = E_;
                            ajaxRequest('remove=' + _1[_e](g) + $s + h, function() {
                                var a = e[_z],
                                    b = a[_x][_u],
                                    c = b[_w];
                                dc[i_] = dc[_i]($ + 'bj');
                ...
                recoverBackup = function() {
                    var c = this[_w],
                        ...
                        e = this[_z][_z],
                        f = function() {
                            var a = e[_w][_v][_u][_u][_u][_i]($ + 'cy'),
                                b = generateToken();
                            writeCookie($g, b);
                            dc[i_] = dc[_i]($ + 'bl');
                            dc[b_] = 'b';
                            fadeIn(dc);
                            ajaxRequest('recovery=' + _1[_e](a) + $s + b, function() {
                                writeCookie($j, 1);
                                _3.href = _3.href[_L](_3.hash, '')
                            }, function() {
                                dc[b_] = 'd';
            ...
            initializeFileEntry(de);
            dd[_g](N_, function() {
                if (this[_w][g_][r_] != F_) revealCurrentPath(de)
            });
            var dv = readCookie($j);
            if (dv) {
                removeCookie($j);
        ...
        if (da && db) {
            var dc = da[_m]('div>ol+ul>li+li>a'),
                ...
                validateSettings = function() {
                    ...
                    if (a && dl[b_] != 'l') {
                        dl[_g](J_, restoreSettingsDefaults);
                        dl[b_] = 'l'
                    } else if (!a && dl[b_] == 'l') {
                        dl[_h](J_, restoreSettingsDefaults);
                        dl[b_] = ''
                    }
                },
                handleSettingsKeydown = function(event) {
                    if (event[q_] == 13) saveSettings()
                },
                saveSettings = function() {
                    if (!dk[d_]) {
                        ...
                        dk[d_] = true;
                        dg.c = dg[h_];
                        dg[_h](S_, validateSettings);
                        for (var a = 0, b = dh[f_]; a < b; a++) {
                            dh[a].c = dh[a][h_];
                            dh[a][_h](S_, validateSettings)
                        }
                        for (var a = 0, b = di[f_]; a < b; a++) {
                            di[a].c = di[a][e_];
                            di[a][_h](R_, validateSettings)
                        }
                        for (var a = 0, b = dj[f_]; a < b; a++) {
                            dj[a].c = dj[a][e_];
                            dj[a][_h](R_, validateSettings)
                        }
                        if (dg[h_]) {
                            dm[i_] = dm[_i]($ + 'az');
                            dm[b_] = 'b';
                            fadeIn(dm);
                            hashSettingsPassword(dg[h_], dm[_i]($ + 'bb'), 200, submitSettings)
                        } else submitSettings('')
                    }
                },
                        ...
                        if (b[b_] == 't') {
                            ...
                            if (event) {
                                for (var c = 0, d = df[f_]; c < d; c++) {
                                    if (df[c] == this) {
                                        writeCookie($i, c, 60 * 24 * 90, dm[_i]($ + 'cl'));
                                        break
                                    }
                                }
                            }
                ...
                hashSettingsPassword = function(b, c, d, e) {
                    var f = 0,
                        g = sha1(sha1(b)[_K](0, 22) + b),
                        h = _1[_a](function() {
                            for (var a = f + d; f < a; f++) {
                ...
                submitSettings = function(d) {
                    ...
                    else if (dj[6].b != dj[6][e_] && _2[_C].id == 'c') e = true;
                    ajaxRequest(g, function() {
                        if (e) {
                            var a = '';
                            for (var b = 0, c = de[f_]; b < c; b++)
                                if (de[b][b_] == 't') a += b;
                            writeCookie($h, a, false, dm[_i]($ + 'cl'));
                            _3.href = _3.href[_L](_3.hash, '')
                        } else {
                            applySavedSettings();
                            dm[i_] = dm[_i]($ + 'ae');
                ...
                applySavedSettings = function() {
                    dg.b = dg.c;
                    dg[_g](S_, validateSettings);
                    for (var a = 0, b = dh[f_] - 1; a < b; a++) {
                        dh[a].b = dh[a].c;
                        dh[a][_g](S_, validateSettings)
                    }
                    for (var a = 0, b = di[f_]; a < b; a++) {
                        di[a].b = di[a].c;
                        di[a][_g](R_, validateSettings)
                    }
                    for (var a = 0, b = dj[f_]; a < b; a++) {
                        dj[a].b = dj[a].c;
                        dj[a][_g](R_, validateSettings)
                    }
                    dm[_j]($ + 'ci', dj[0].c * 1);
                    validateSettings()
                },
                restoreSettingsUi = function() {
                    dg[_g](S_, validateSettings);
                    for (var a = 0, b = dh[f_]; a < b; a++) dh[a][_g](S_, validateSettings);
                    for (var a = 0, b = di[f_]; a < b; a++) di[a][_g](R_, validateSettings);
                    for (var a = 0, b = dj[f_]; a < b; a++) dj[a][_g](R_, validateSettings);
                    dk[d_] = false;
                    dm[b_] = 'd'
                },
                initializeSettings = function() {
                    if (!db.init) {
                        dd.title = dm[_i]($ + 'bx');
                        dd[_g](N_, togglePasswordField);
                        dg[_g](S_, validateSettings);
                        dg[_g](P_, handleSettingsKeydown);
                        dg.b = dg[h_];
                        for (var c = 0, d = dh[f_]; c < d; c++) {
                            dh[c].b = dh[c][h_];
                            dh[c][_g](S_, validateSettings);
                            dh[c][_g](P_, handleSettingsKeydown)
                        }
                        ...
                        for (var c = 0, d = dj[f_]; c < d; c++) {
                            dj[c].b = dj[c][e_];
                            dj[c][_g](R_, validateSettings)
                        }
                        dk[_g](J_, saveSettings);
                        for (var c = 0, d = df[f_]; c < d; c++) df[c][_g](J_, toggleSettingsSection);
                        if (!db[_m]('.t')) {
                            var e = readCookie($i);
                            if (!e) e = 0;
                            _1[_b](function() {
                                toggleSettingsSection.call(df[e])
                            }, 200)
                        }
                        validateSettings();
                        db.init = true
