...
(function() {
    ...
    var writeCookie = function(runtimeInput1, runtimeInput2, runtimeInput3, runtimeInput4) {
            var runtimeValue5 = windowObject[encodeURIComponentMethod](runtimeInput1) + '=' + windowObject[encodeURIComponentMethod](runtimeInput2);
            if (runtimeInput3) {
                var runtimeValue6 = new Date();
                runtimeValue6.setTime(runtimeValue6.getTime() + (1000 * 60 * runtimeInput3));
                runtimeValue5 += ';expires=' + runtimeValue6.toUTCString()
            }
            if (runtimeInput4) runtimeValue5 += ';path=' + windowObject[encodeURIComponentMethod](runtimeInput4)[splitMethod]('%2F')[joinMethod]('/');
            documentObject.cookie = runtimeValue5
        },
        removeCookie = function(runtimeInput5, runtimeInput6) {
            writeCookie(runtimeInput5, 1, -1, runtimeInput6)
        },
        readCookie = function(runtimeInput7) {
            var runtimeValue8 = documentObject.cookie[matchMethod]('(^|;) ?' + runtimeInput7 + ' ?= ?([^;]*)(;|$)');
            if (runtimeValue8) return runtimeValue8[2]
        },
        ...
        hidePanel = function(runtimeInput25, runtimeInput26) {
            if (runtimeInput25[styleProperty][overflowProperty] != hiddenValue && windowObject[getComputedStyleMethod](runtimeInput25)[displayProperty] != noneValue) {
                var runtimeValue27 = runtimeInput25[clientHeightProperty];
        ...
        utf8Encode = function(runtimeInput27) {
            var runtimeValue28, runtimeValue29, runtimeValue30 = '';
            runtimeValue29 = String.fromCharCode;
            runtimeInput27 = runtimeInput27[replaceMethod](new RegExp('\r\n', 'g'), '\n');
            for (runtimeValue28 = 0; runtimeValue28 < runtimeInput27[lengthProperty]; runtimeValue28++) {
                var runtimeValue31 = runtimeInput27[charCodeAtMethod](runtimeValue28);
                if (runtimeValue31 < 128) runtimeValue30 += runtimeValue29(runtimeValue31);
                else if ((runtimeValue31 > 127) && (runtimeValue31 < 2048)) {
                    runtimeValue30 += runtimeValue29((runtimeValue31 >> 6) | 192);
                    runtimeValue30 += runtimeValue29((runtimeValue31 & 63) | 128)
                } else {
                    runtimeValue30 += runtimeValue29((runtimeValue31 >> 12) | 224);
                    runtimeValue30 += runtimeValue29(((runtimeValue31 >> 6) & 63) | 128);
                    runtimeValue30 += runtimeValue29((runtimeValue31 & 63) | 128)
                }
            }
            return runtimeValue30
        },
        sha1 = function(runtimeInput28) {
            var runtimeValue32 = function(sha1Argument1, sha1Argument2) {
                    return (sha1Argument1 << sha1Argument2) | (sha1Argument1 >>> (32 - sha1Argument2))
                },
                runtimeValue33 = function(sha1Argument3) {
                ...
                runtimeValue34, runtimeValue35, runtimeValue36, runtimeValue37, runtimeValue38, runtimeValue39, runtimeValue40, runtimeValue41, runtimeValue42, runtimeValue43, runtimeValue44, runtimeValue45, runtimeValue46 = 0x67452301,
                runtimeValue47 = 0xEFCDAB89,
                runtimeValue48 = 0x98BADCFE,
                runtimeValue49 = 0x10325476,
                runtimeValue50 = 0xC3D2E1F0;
            runtimeInput28 = utf8Encode(runtimeInput28);
            runtimeValue38 = runtimeInput28[lengthProperty];
            runtimeValue34 = new Array();
            runtimeValue45 = new Array(80);
            for (runtimeValue36 = 0; runtimeValue36 < runtimeValue38 - 3; runtimeValue36 += 4) {
                runtimeValue37 = runtimeInput28[charCodeAtMethod](runtimeValue36) << 24 | runtimeInput28[charCodeAtMethod](runtimeValue36 + 1) << 16 | runtimeInput28[charCodeAtMethod](runtimeValue36 + 2) << 8 | runtimeInput28[charCodeAtMethod](runtimeValue36 + 3);
                runtimeValue34.push(runtimeValue37)
            }
            switch (runtimeValue38 % 4) {
                case 0:
                    runtimeValue36 = 0x080000000;
                    break;
                case 1:
                    runtimeValue36 = runtimeInput28[charCodeAtMethod](runtimeValue38 - 1) << 24 | 0x0800000;
                    break;
                case 2:
                    runtimeValue36 = runtimeInput28[charCodeAtMethod](runtimeValue38 - 2) << 24 | runtimeInput28[charCodeAtMethod](runtimeValue38 - 1) << 16 | 0x08000;
                    break;
                case 3:
                    runtimeValue36 = runtimeInput28[charCodeAtMethod](runtimeValue38 - 3) << 24 | runtimeInput28[charCodeAtMethod](runtimeValue38 - 2) << 16 | runtimeInput28[charCodeAtMethod](runtimeValue38 - 1) << 8 | 0x80;
                    break
            }
            runtimeValue34.push(runtimeValue36);
            while ((runtimeValue34[lengthProperty] % 16) != 14) runtimeValue34.push(0);
            runtimeValue34.push(runtimeValue38 >>> 29);
            runtimeValue34.push((runtimeValue38 << 3) & 0x0ffffffff);
            for (runtimeValue35 = 0; runtimeValue35 < runtimeValue34[lengthProperty]; runtimeValue35 += 16) {
                for (runtimeValue36 = 0; runtimeValue36 < 16; runtimeValue36++) runtimeValue45[runtimeValue36] = runtimeValue34[runtimeValue35 + runtimeValue36];
                for (runtimeValue36 = 16; runtimeValue36 <= 79; runtimeValue36++) runtimeValue45[runtimeValue36] = runtimeValue32(runtimeValue45[runtimeValue36 - 3] ^ runtimeValue45[runtimeValue36 - 8] ^ runtimeValue45[runtimeValue36 - 14] ^ runtimeValue45[runtimeValue36 - 16], 1);
                runtimeValue40 = runtimeValue46;
                runtimeValue41 = runtimeValue47;
                runtimeValue42 = runtimeValue48;
                runtimeValue43 = runtimeValue49;
                runtimeValue44 = runtimeValue50;
                for (runtimeValue36 = 0; runtimeValue36 <= 19; runtimeValue36++) {
                    runtimeValue39 = (runtimeValue32(runtimeValue40, 5) + ((runtimeValue41 & runtimeValue42) | (~runtimeValue41 & runtimeValue43)) + runtimeValue44 + runtimeValue45[runtimeValue36] + 0x5A827999) & 0x0ffffffff;
                    runtimeValue44 = runtimeValue43;
                    runtimeValue43 = runtimeValue42;
                    runtimeValue42 = runtimeValue32(runtimeValue41, 30);
                    runtimeValue41 = runtimeValue40;
                    runtimeValue40 = runtimeValue39
                }
                for (runtimeValue36 = 20; runtimeValue36 <= 39; runtimeValue36++) {
                    runtimeValue39 = (runtimeValue32(runtimeValue40, 5) + (runtimeValue41 ^ runtimeValue42 ^ runtimeValue43) + runtimeValue44 + runtimeValue45[runtimeValue36] + 0x6ED9EBA1) & 0x0ffffffff;
                    runtimeValue44 = runtimeValue43;
                    runtimeValue43 = runtimeValue42;
                    runtimeValue42 = runtimeValue32(runtimeValue41, 30);
                    runtimeValue41 = runtimeValue40;
                ...
                for (runtimeValue36 = 40; runtimeValue36 <= 59; runtimeValue36++) {
                    runtimeValue39 = (runtimeValue32(runtimeValue40, 5) + ((runtimeValue41 & runtimeValue42) | (runtimeValue41 & runtimeValue43) | (runtimeValue42 & runtimeValue43)) + runtimeValue44 + runtimeValue45[runtimeValue36] + 0x8F1BBCDC) & 0x0ffffffff;
                    runtimeValue44 = runtimeValue43;
                    runtimeValue43 = runtimeValue42;
                    runtimeValue42 = runtimeValue32(runtimeValue41, 30);
                    runtimeValue41 = runtimeValue40;
                ...
                for (runtimeValue36 = 60; runtimeValue36 <= 79; runtimeValue36++) {
                    runtimeValue39 = (runtimeValue32(runtimeValue40, 5) + (runtimeValue41 ^ runtimeValue42 ^ runtimeValue43) + runtimeValue44 + runtimeValue45[runtimeValue36] + 0xCA62C1D6) & 0x0ffffffff;
                    runtimeValue44 = runtimeValue43;
                    runtimeValue43 = runtimeValue42;
                    runtimeValue42 = runtimeValue32(runtimeValue41, 30);
                    runtimeValue41 = runtimeValue40;
                ...
                runtimeValue46 = (runtimeValue46 + runtimeValue40) & 0x0ffffffff;
                runtimeValue47 = (runtimeValue47 + runtimeValue41) & 0x0ffffffff;
                runtimeValue48 = (runtimeValue48 + runtimeValue42) & 0x0ffffffff;
                runtimeValue49 = (runtimeValue49 + runtimeValue43) & 0x0ffffffff;
                runtimeValue50 = (runtimeValue50 + runtimeValue44) & 0x0ffffffff
            }
            return (runtimeValue33(runtimeValue46) + runtimeValue33(runtimeValue47) + runtimeValue33(runtimeValue48) + runtimeValue33(runtimeValue49) + runtimeValue33(runtimeValue50))[toLowerCaseMethod]()
        },
        base64Encode = function(runtimeInput29) {
            return btoa(windowObject[encodeURIComponentMethod](runtimeInput29)[replaceMethod](new RegExp('%([0-9A-F]{2})', 'g'), function(base64EncodeArgument1, base64EncodeArgument2) {
                return String.fromCharCode('0x' + base64EncodeArgument2)
            }))
        },
        base64Decode = function(runtimeInput29) {
            try {
                runtimeInput29 = runtimeInput29[replaceMethod](/-/g, '+')[replaceMethod](/_/g, '/');
                while (runtimeInput29[lengthProperty] % 4) runtimeInput29 += '=';
                return windowObject[decodeURIComponentMethod](Array.prototype.map.call(atob(runtimeInput29), function(base64DecodeValue1) {
        ...
        base64UrlEncode = function(runtimeInput30) {
            return base64Encode(runtimeInput30)[replaceMethod](/\+/g, '-')[replaceMethod](/\//g, '_')[replaceMethod](/=+$/, '')
        },
        ajaxRequest = function(runtimeInput30, runtimeInput31, runtimeInput32, runtimeInput33, runtimeInput34, runtimeInput35) {
            var runtimeValue51 = new XMLHttpRequest();
            if (runtimeInput35) {
                runtimeInput33.call(runtimeValue51);
                return
            }
            runtimeValue51.open('POST', locationObject.href, true);
            runtimeValue51[setRequestHeaderMethod]('AJAX', 1)
            runtimeValue51.onreadystatechange = function() {
                if (runtimeValue51.readyState == 4) {
            ...
            if (runtimeInput30.charAt) {
                var runtimeValue52 = windowObject[setTimeoutMethod](function() {
                    runtimeValue51.onreadystatechange = function() {};
                    runtimeInput33.call(runtimeValue51)
                }, 20000);
                runtimeValue51[setRequestHeaderMethod]('Content-Type', 'application/x-www-form-urlencoded')
            } else {
                var runtimeValue53 = function() {
                        return windowObject[setTimeoutMethod](function() {
                            runtimeValue51.onreadystatechange = function() {};
                            runtimeValue51.upload.onprogress = function() {};
                            runtimeInput33.call(runtimeValue51)
                        }, 20000)
                    },
                    runtimeValue52 = runtimeValue53(),
                    runtimeValue54 = 0;
                runtimeValue51.upload.onprogress = function(event) {
                    if (event.loaded > runtimeValue54) {
                        runtimeValue54 = event.loaded;
                        windowObject[clearTimeoutMethod](runtimeValue52);
                        runtimeInput34.call(runtimeValue51, runtimeValue54, event.total)
                    } else runtimeValue52 = runtimeValue53()
                };
                runtimeInput34.call(runtimeValue51, 0, 0)
            }
        ...
        formatBytes = function(runtimeInput36) {
            var runtimeValue55 = 1024,
                ...
                runtimeValue57 = 1024 * runtimeValue56,
                runtimeValue58 = 1024 * runtimeValue57;
            if (runtimeInput36 < runtimeValue56) return (runtimeInput36 / runtimeValue55)[toFixedMethod](2) + ' KB';
            else if (runtimeInput36 < runtimeValue57) return (runtimeInput36 / runtimeValue56)[toFixedMethod](2) + ' MB';
            else if (runtimeInput36 < runtimeValue58) return (runtimeInput36 / runtimeValue57)[toFixedMethod](2) + ' GB';
            else return (runtimeInput36 / runtimeValue58)[toFixedMethod](2) + ' TB'
        };
    documentObject[addEventListenerMethod](domContentLoadedEvent, function() {
        ...
        if (authPage) {
            var loginButton = authPage[querySelectorMethod]('input[type="button"]'),
                ...
                submitLogin = function(runtimeInput41) {
                    authStatus[innerHTMLProperty] = authStatus[getAttributeMethod](dataAttributePrefix + 'cr');
                    ajaxRequest('password=' + windowObject[encodeURIComponentMethod](runtimeInput41), function() {
